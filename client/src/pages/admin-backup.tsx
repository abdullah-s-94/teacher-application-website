...
export default function Admin() {
  ...
  // Main dashboard return - show for all logged in users with proper gender selection
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 relative overflow-hidden">
      ...
      <main className="container mx-auto px-4 py-8 relative z-10">
                                          ...
                                          <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg border">
                                            <div className="flex items-center gap-3">
                                              ...
                                              <div>
                                                ...
                                                <p className="text-sm text-slate-500">{getDisplayFileName(application.cvOriginalName, application.fullName, application.id)}</p>
                                              </div>
                                            </div>
                                            <div className="flex gap-2">
                                              <Button
                                              ...
                                              <Button
                                                size="sm"
                                                onClick={() => downloadCV(application.id, application.cvOriginalName)}
                                              >
        ...
        {/* Filters and Search */}
        <Card className="mb-8 bg-white/80 backdrop-blur-sm border border-slate-200/60">
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              <Select value={experienceFilter} onValueChange={setExperienceFilter}>
                ...
                <SelectContent>
                  <SelectItem value="all">جميع مستويات الخبرة</SelectItem>
              ...
              <Select value={specializationFilter} onValueChange={setSpecializationFilter}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="early_childhood">رياض الأطفال</SelectItem>
                  <SelectItem value="arabic">اللغة العربية</SelectItem>
                  <SelectItem value="english">اللغة الإنجليزية</SelectItem>
                  <SelectItem value="computer_science">الحاسب الآلي</SelectItem>
                  ...
                  <SelectItem value="business_admin">إدارة أعمال</SelectItem>
                  <SelectItem value="biology">الأحياء</SelectItem>
                  <SelectItem value="home_economics">الاقتصاد المنزلي</SelectItem>
                  <SelectItem value="religion">التربية الإسلامية</SelectItem>
              ...
              <Select value={licenseFilter} onValueChange={setLicenseFilter}>
                <SelectTrigger>
                  <SelectValue placeholder="الرخصة المهنية" />
                </SelectTrigger>
                <SelectContent>
              ...
              <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium text-blue-800">
                    تم تحديد {selectedApplications.length} طلبات
                  </span>
                  <div className="flex gap-2">
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        ...
                        >
                          ...
                          حذف المُحدد ({selectedApplications.length})
                        </Button>
                      </AlertDialogTrigger>
                      <AlertDialogContent dir="rtl">
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            سيتم حذف {selectedApplications.length} طلبات نهائياً. هذا الإجراء لا يمكن التراجع عنه.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
  ...
  // This should not be reached due to the early returns above
  return null;
}
