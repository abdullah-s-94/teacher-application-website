      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="flex justify-center items-center gap-4 mb-8 group">
            ...
            <h1 className="text-5xl font-bold bg-gradient-to-r from-slate-800 via-gray-700 to-slate-600 bg-clip-text text-transparent">
              مدارس أنجال النخبة الأهلية
            </h1>
          </div>
          <div className="relative inline-block mb-8 animate-float">
            <p className="text-xl text-slate-600 px-6 py-3 bg-white/70 backdrop-blur-sm rounded-full border border-slate-200/50 shadow-lg animate-glow">
              نظام التوظيف الإلكتروني الموحد
            </p>
          </div>
          <h2 className="text-2xl font-semibold text-slate-700 mb-6 animate-fade-in">
          ...
          <Card className="overflow-hidden border border-slate-200/60 hover:border-slate-300/80 transition-all duration-500 cursor-pointer group bg-white/80 backdrop-blur-sm hover:shadow-2xl hover:shadow-slate-200/50 hover:-translate-y-2">
            <CardContent className="p-8 text-center relative" onClick={() => handleSelection('male')}>
              ...
              <div className="relative z-10">
                ...
                <Button 
                  size="lg" 
                  className="w-full bg-gradient-to-r from-slate-600 to-slate-700 hover:from-slate-700 hover:to-slate-800 text-white py-3 rounded-xl transition-all duration-300 group-hover:shadow-lg flex items-center justify-center gap-2"
                >
        ...
        <div className="text-center mt-20">
          <div className="inline-block">
            <p className="text-slate-500 text-sm px-6 py-2 bg-white/40 backdrop-blur-sm rounded-full border border-slate-200/30">
